...
class Ram(unittest.TestCase):
    ...
    def test_search_novoPI(self):
        ...
        driver.find_element_by_xpath("//input[@id='PontoInteresse_Nome']").send_keys("a", Keys.TAB, "a", Keys.TAB, "a",
                                                                                     Keys.TAB, "a", Keys.TAB, 1990,
                                                                                     Keys.TAB, Keys.TAB, 123, Keys.TAB,
                                                                                     123, Keys.TAB, 123, Keys.TAB, 123,
                                                                                     Keys.TAB)
